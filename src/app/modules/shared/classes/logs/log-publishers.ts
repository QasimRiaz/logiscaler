...
import * as Query from 'app/modules/shared/graphQL/functions.graphql';
      ...
      .subscribe<boolean>({
        ...
        variables: {
          request: {
            ...
            body: {
              userId: entry.userInfo && entry.userInfo.id ? entry.userInfo.id.toString() : '',
              email: entry.userInfo && entry.userInfo.email ? entry.userInfo.email : '',
