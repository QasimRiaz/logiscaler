...
export class AuthSignInComponent implements OnInit {
     ...
     */
    ngOnInit(): void {
        this._logger.info("User landed on the sign-in page");
        // Create the form
     ...
     */
    signIn(): void {
        this._logger.info("User click on sign-in button", this.signInForm.value);
        ...
        this._authService.signIn(this.signInForm.value)
            .subscribe(
                ...
                error => {
                    this._logger.info("User Login failed: Wrong email or password", error);
